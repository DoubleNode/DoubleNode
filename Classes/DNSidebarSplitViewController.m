//
//  DNSidebarSplitViewController.m
//  DoubleNode.com
//
...
#import "DNSidebarSplitViewController.h"
...
@implementation DNSidebarSplitViewController
 ...
 withIsShowingBlock:(RevealBlock_Bool)isShowingBlock
{
    ...
    if (self)
    {
        ...
        self.hideMenuViewControllerInPortraitOrientation = YES;

        self.listButtonTitle = @"Questions";
        self.MenuViewControllerHiddenLeftButtonsImage = [UIImage imageNamed:@"menuicon"];
    }
